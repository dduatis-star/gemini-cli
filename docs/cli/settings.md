...
| Auto Distillation                  | `experimental.autoDistillation`                   | Enable automatic distillation for large tool outputs.                                                                                                     | `false` |
...
| Target Retained Tokens             | `experimental.agentHistoryTargetRetainedTokens`   | The target number of tokens to retain in the session history.                                                                                             | `60000` |
| Normal Message Tokens              | `experimental.agentHistoryNormalMessageTokens`    | The target number of tokens to budget for a normal conversation turn.                                                                                     | `2500`  |
| Maximum Message Tokens             | `experimental.agentHistoryMaximumMessageTokens`   | The maximum number of tokens a single conversation turn can consume before truncation.                                                                    | `10000` |
| Normalization Head Ratio           | `experimental.agentHistoryNormalizationHeadRatio` | The ratio of tokens to retain from the beginning of a truncated message (0.0 to 1.0).                                                                     | `0.2`   |
